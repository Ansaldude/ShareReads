            ...
            <div >
                < div className="sidebar" >
                    <div className="side-header with-border">
                        <div className="img">
                            <img src={"http://localhost:3000/images/" + this.state.user.image} id="navimg" className="img-circle" alt="avatar" />
                    ...
                    <div className="sidebar-conatiner no-padding">
                        ...
                        <ul className="nav nav-pills nav-stacked">
                            ...
                            <li><a href="userdetails"><i className="fa fa-users"></i> User Detail</a></li>
                             ...
                             <li><a href="bookdetails"><i className="fa fa-book"></i> Book Detail</a></li>
